<div class="col-md-3">
    <div data-id="3" @if(isset($item->sale)) data-min-order="{{$txt->wholesale_text}}" @endif class="card"><a href="{{\App\Helpers\Catalog\Products::buildUrl($item->meta['alias'],$active)}}"
                                     class="img"><img
                    src="{{$item['images'][0] ?? ''}}" alt=""></a>
        ...
        <div class="card-bottom">
            <div class="card-prices">
               @if($item->old_price) <div class="old-price strike accent dollar">{{$item->old_price}}</div> @endif
